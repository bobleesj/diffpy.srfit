...
A Python package package for building a global optimizer on the fly from components such as function calculators, regression algorithms, and structure models.
